        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav  mb-2 mb-lg-0">
              ...
              <li className="nav-item">
                <Link className="nav-link" to="/recetas" id="recetas">
                  Recetas
                </Link>
              </li>
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu pt-0 pb-0">
                  <div className="d-flex justify-content-between">
                    ...
                    <div className="me-1" id="tooltip-container">
                      <svg
                      ...
                      <span id="tool-tip">
                        Los aperitivos son pequeñas porciones de comida que se
                        sirven antes de una comida principal o en eventos
                        sociales.
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="d-flex justify-content-between">
                    ...
                    <div className="me-1" id="tooltip-container">
                      ...
                      <span id="tool-tip">
                        Las recetas de desayunos están diseñadas específicamente
                  ...
                  <div className="d-flex justify-content-between">
                    ...
                    <div className="me-1" id="tooltip-container">
                      ...
                      <span id="tool-tip">
                        Estas recetas se refieren a platos ligeros que se sirven
                        al comienzo de una comida para abrir el apetito. Las
                        entradas suelen ser pequeñas porciones de alimentos como
                        sopas, ensaladas, canapés o salsas para mojar.
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="d-flex justify-content-between">
                    ...
                    <div className="me-1" id="tooltip-container">
                      ...
                      <span id="tool-tip">
                        Las recetas para fechas festivas son platos especiales
                        que se preparan para celebrar ocasiones especiales como
                        Navidad, Carnaval u otras festividades.
                      </span>
                    </div>
                  </div>
                  <li>
                  ...
                  <div className="d-flex justify-content-between">
                    ...
                    <div className="me-1" id="tooltip-container">
                      ...
                      <span id="tool-tip">
                        Las recetas de platos principales son el plato principal
                        de una comida y generalmente constan de una combinación
                        de proteínas (como carne, pollo o pescado) y
                        acompañamientos (como arroz, pasta, verduras o papas).
                        Estas recetas suelen ser más sustanciosas y completas
                        que las entradas.
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="d-flex justify-content-between">
                    ...
                    <div className="me-1" id="tooltip-container">
                      ...
                      <span id="tool-tip">
                        Las recetas de postres son deliciosos y dulces platos
                        que se sirven al final de una comida.{" "}
                      </span>
                    </div>
                  </div>
                </ul>
              ...
              <li className="nav-item">
                <Link className="nav-link" to="/favoritos" id="favoritos">
                  Favoritos
                </Link>
              </li>
            </ul>
            ...
            >
              ...
              ></input>
              <button className="btn" type="submit" id="btn-buscar">
                Buscar
              </button>
            </form>
            {!currentUser ? (
